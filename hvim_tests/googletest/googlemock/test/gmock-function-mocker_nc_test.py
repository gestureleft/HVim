"""Negative compilation hvim_tests for Google Mock macro MOCK_METHOD."""
...
if not IS_LINUX:
  sys.stderr.write(
      "WARNING: Negative compilation hvim_tests are not supported on this platform")
  sys.exit(0)
...
class GMockMethodNCTest(googletest.TestCase):
  """Negative compilation hvim_tests for MOCK_METHOD."""
